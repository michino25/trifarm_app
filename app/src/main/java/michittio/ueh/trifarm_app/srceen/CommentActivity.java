...
=======
    public static ArrayList<Comment> getListComment(int number) {

        return new ArrayList<>(getListComment().subList(0, number));
    }
>>>>>>> 08962b0d8ff8a0ef877362572da43fde9d6ef9d2
